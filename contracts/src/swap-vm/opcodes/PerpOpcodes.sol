...
import { FundingCalc } from "../instructions/FundingCalc.sol";
...
contract PerpOpcodes is AquaOpcodes {
    ...
    uint256 public constant OP_FUNDING_CALC = 0x75;
    ...
    function _runOpcode(Context memory ctx, uint256 opcode, bytes calldata args) internal virtual override {
        ...
        } else if (opcode == OP_FUNDING_CALC) {
            FundingCalc.exec(ctx, args);
        } else {
